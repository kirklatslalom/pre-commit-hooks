...
TESTS = (
    ...
    (
        ...
        1,
        "{filename}:2: Module docstring appears after code " "(code seen on line 1).\n",
    ),
    ...
    (
        ...
        b'"fake docstring"\n',
        1,
        "{filename}:3: Multiple module docstrings " "(first docstring on line 1).\n",
    ),
    # Test multiple lines of code above
    (
        b"import os\n" b"import sys\n" b'"docstring"\n',
        1,
        "{filename}:3: Module docstring appears after code " "(code seen on line 1).\n",
    ),
